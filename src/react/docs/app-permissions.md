...
* The app requires Application Admin to consent and the following **read-only** permissions to the same user who is running this tool.
  * Agreement.Read.All
...
The output generation may take from a few minutes to hours depending on the size of your tenant. 
